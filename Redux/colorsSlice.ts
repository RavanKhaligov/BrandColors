...
// Function to get selected brands from localStorage
const getSelectedBrandsFromLocalStorage = () => {
...
const initialState: colorSliceTypes = {
  ...
  selectedBrands: getSelectedBrandsFromLocalStorage(), // Initialize here
  copied: '',
  isShowing: false,
  search: ''
};
